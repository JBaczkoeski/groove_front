<template>
  <div class="container-fluid">
    ...
    <div class="container col-12 d-flex justify-content-center py-3">
      <div class="row">
    ...
    <div class="container col-12 text-center py-3 border-home mid-back-color">
      <div class="row">
    ...
    <div class="container col-12 text-center border-home mid-back-color">
      <div class="row">
        <div class="col-12 col-sm-6 pt-5 mt-4">
