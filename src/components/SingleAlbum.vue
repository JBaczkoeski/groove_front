<template>
  <div
    ...
    <img v-if="cover !== undefined && cover !== ''" :src="cover" style="margin-left: 50px"
         class="w-75 mt-4 rounded-4 mx-auto"
         alt="album cover">
    ...
    <div class="card-body row">
      ...
      <a :href="`/album/show/${id}`" style="max-height: 45px"
         class="btn btn-success rounded rounded-pill my-4">Podgląd</a>
    </div>
  </div>
</template>
